...
(function(t) {
  ...
  h.prototype.clear = function() {
    ...
    for (var a in this.visible_nodes) {
      if (console.log(this.visible_nodes[a]), this.visible_nodes[a] && this.visible_nodes[a] && "function" == typeof this.visible_nodes[a].onHideNode) {
    ...
    if (a) {
      ...
      if (this.graph) {
        ...
        if (this.lastVisibleNodes) {
          for (var c = 0; c < this.lastVisibleNodes.length; ++c) {
  ...
  h.prototype.showSearchBox = function(a) {
    ...
    k.innerHTML = "<input autofocus type='text' width='100%' height='100%' style='z-index:99;font-size:18px;' class='value rounded'/><div class='helper'></div>";
    k.close = function() {
      e.search_box = null;
      document.body.focus();
      setTimeout(function() {
