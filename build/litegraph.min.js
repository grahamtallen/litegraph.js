...
(function(t) {
  ...
  STRAIGHT_LINK:0, LINEAR_LINK:1, SPLINE_LINK:2, NORMAL_TITLE:0, NO_TITLE:1, TRANSPARENT_TITLE:2, AUTOHIDE_TITLE:3, proxy:null, node_images_path:"", debug:!0, catch_exceptions:!0, throw_errors:!0, allow_scripts:!1, registered_node_types:{}, node_types_by_file_extension:{}, Nodes:{}, searchbox_extras:{}, registerNodeType:function(a, b) {
    if (!b.prototype) {
    ...
    for (var h = Array(b.length), g = "", l = f.getParameterNames(b), k = 0; k < l.length; ++k) {
      g += "this.addInput('" + l[k] + "'," + (c && c[k] ? "'" + c[k] + "'" : "0") + ");\n";
    }
  ...
  m.prototype.computeExecutionOrder = function(a, b) {
    for (var c = [], d = [], e = {}, h = {}, g = {}, l = 0, k = this._nodes.length; l < k; ++l) {
      var n = this._nodes[l];
      if (!a || n.onExecute) {
        e[n.id] = n;
        var p = 0;
        ...
        for (l = 0; l < n.outputs.length; l++) {
          if (a = n.outputs[l], null != a && null != a.links && 0 != a.links.length) {
            for (q = 0; q < a.links.length; q++) {
              (k = this.links[a.links[q]]) && !h[k.id] && (p = this.getNodeById(k.target_id), null == p ? h[k.id] = !0 : (b && (!p._level || p._level <= n._level) && (p._level = n._level + 1), h[k.id] = !0, --g[p.id], 0 == g[p.id] && d.push(p)));
            }
          }
        }
      }
  ...
  m.prototype.arrange = function(a) {
    ...
    for (d = 0; d < c.length; ++d) {
      if (f = c[d]) {
        for (var g = 100, l = a, k = 0; k < f.length; ++k) {
          e = f[k], e.pos[0] = b, e.pos[1] = l, e.size[0] > g && (g = e.size[0]), l += e.size[1] + a;
        }
        b += g + a;
      }
    }
    ...
    if (a) {
      ...
      if (b) {
        ...
        for (e = b.length; d < e; ++d) {
          ...
          g || (f.debug && console.log("Node not found or has errors: " + h.type), g = new r, g.last_serialization = h, c = g.has_errors = !0);
          g.id = h.id;
          this.add(g, !0);
        }
        d = 0;
      ...
      for (var d = 0; d < a.length; ++d) {
        ...
        if (null == c || c == e) {
          ...
          if (h && (h._last_time = f.getTime(), e = this.graph.getNodeById(h.target_id))) {
            if (h = e.inputs[h.target_slot], e.onAction) {
              e.onAction(h.name, b);
            } else {
  ...
  r.prototype.computeSize = function(a, b) {
    ...
    if (this.outputs) {
      for (g = 0, l = this.outputs.length; g < l; ++g) {
        k = this.outputs[g], k = k.label || k.name || "", k = c(k), h < k && (h = k);
      }
    }
    b[0] = Math.max(e + h + 10, a);
  ...
  r.prototype.connect = function(a, b, c) {
    ...
    var e = b.inputs[c], h = null;
    if (f.isValidConnection(d.type, e.type)) {
      h = new v(++this.graph.last_link_id, e.type, this.id, a, b.id, c);
      this.graph.links[h.id] = h;
      null == d.links && (d.links = []);
      d.links.push(h.id);
      b.inputs[c].link = h.id;
      this.graph && this.graph._version++;
      if (this.onConnectionsChange) {
        this.onConnectionsChange(f.OUTPUT, a, !0, h, d);
      }
      if (b.onConnectionsChange) {
        b.onConnectionsChange(f.INPUT, c, !0, h, e);
      }
  ...
  r.prototype.disconnectInput = function(a) {
    ...
    if (d) {
      ...
      for (var g = 0, l = h.links.length; g < l; g++) {
        if (h.links[g] == c) {
          h.links.splice(g, 1);
          break;
        }
  ...
  t.LGraphCanvas = f.LGraphCanvas = k;
        ...
        if (1 == a.which) {
          ...
          if (c && this.allow_interaction && !d && !this.read_only) {
            ...
            if (!d) {
              ...
              c.onMouseDown && c.onMouseDown(a, [a.canvasX - c.pos[0], a.canvasY - c.pos[1]], this) ? g = !0 : this.live_mode && (g = h = !0);
            ...
            if (!this.read_only) {
              for (g = 0; g < this.visible_links.length; ++g) {
                if (c = this.visible_links[g], h = c._pos, !(!h || a.canvasX < h[0] - 4 || a.canvasX > h[0] + 4 || a.canvasY < h[1] - 4 || a.canvasY > h[1] + 4)) {
        ...
        this.dragging_rectangle) {
          if (this.graph) {
            ...
            for (h = 0; h < b.length; ++h) {
              d = b[h], d.getBounding(c), D(this.dragging_rectangle, c) && e.push(d);
            }
  ...
  k.prototype.processKey = function(a) {
    if (this.graph) {
      ...
      if ("input" != a.target.localName) {
        if ("keydown" == a.type) {
          if (console.log("KEYDOWN"), "Escape" == a.key && (this.closeSubgraph(), this.ds.reset()), 32 == a.keyCode && (this.showSearchBox(), b = !0), 65 == a.keyCode && (a.metaKey || a.ctrlKey) && (this.selectNodes(), b = !0), "KeyC" == a.code && (a.metaKey || a.ctrlKey) && !a.shiftKey && this.selected_nodes && (this.copyToClipboard(), b = !0), "KeyV" != a.code || !a.metaKey && !a.ctrlKey || a.shiftKey || this.pasteFromClipboard(), 46 != a.keyCode && 8 != a.keyCode || "input" == a.target.localName || 
          "textarea" == a.target.localName || (this.deleteSelectedNodes(), b = !0), this.selected_nodes) {
  ...
  k.prototype.pasteFromClipboard = function() {
    ...
    if (a) {
      ...
      for (c = 0; c < a.links.length; ++c) {
        ...
        e = b[d[0]];
        var h = b[d[2]];
        console.log(d, "CONNECT ", d[1], h, d[3]);
        e.connect(d[1], h, d[3]);
      }
      this.selectNodes(b);
    }
  ...
  k.prototype.processNodeDeselected = function(a) {
    this.deselectNode(a);
  ...
  k.prototype.convertEventToCanvasOffset = function(a) {
    var b = k.active_canvas, c = b.canvas, d = c.width / 2;
    c = c.height / 2;
  ...
  k.prototype.drawNode = function(a, b) {
    ...
    if (this.live_mode) {
      ...
      if (!a.flags.collapsed || !a.onDrawCollapsed || 1 != a.onDrawCollapsed(b, this)) {
        ...
        a.clip_area && (b.save(), b.beginPath(), h == f.BOX_SHAPE ? b.rect(0, 0, B[0], B[1]) : h == f.ROUND_SHAPE ? b.roundRect(0, 0, B[0], B[1], 10) : h == f.CIRCLE_SHAPE && b.arc(0.5 * B[0], 0.5 * B[1], 0.5 * B[0], 0, 2 * Math.PI), b.clip());
        a.has_errors && (d = "red");
        ...
        if (!a.flags.collapsed) {
          if (a.inputs) {
            for (c = 0; c < a.inputs.length; c++) {
              var n = a.inputs[c];
              b.globalAlpha = e;
              this.connecting_node && !f.isValidConnection(n.type, h.type) && (b.globalAlpha = 0.4 * e);
              ...
              var p = a.getConnectionPos(!0, c, k);
              p[0] -= a.pos[0];
              p[1] -= a.pos[1];
          ...
          if (a.outputs) {
            for (c = 0; c < a.outputs.length; c++) {
              if (n = a.outputs[c], p = a.getConnectionPos(!1, c, k), p[0] -= a.pos[0], p[1] -= a.pos[1], l < p[1] + 0.5 * f.NODE_SLOT_HEIGHT && (l = p[1] + 0.5 * f.NODE_SLOT_HEIGHT), b.fillStyle = n.links && n.links.length ? n.color_on || this.default_connection_color.output_on : n.color_off || this.default_connection_color.output_off, b.beginPath(), n.type === f.EVENT || n.shape === f.BOX_SHAPE ? g ? b.rect(p[0] - 5 + 0.5, p[1] - 8 + 0.5, 10, 14) : b.rect(p[0] - 6 + 0.5, p[1] - 5 + 0.5, 14, 10) : 
  ...
  k.prototype.drawNodeShape = function(a, b, c, d, e, h, g) {
    b.strokeStyle = d;
    b.fillStyle = e;
    ...
    if (p || n == f.TRANSPARENT_TITLE) {
      if (a.onDrawTitleBar) {
        ...
        if (n != f.TRANSPARENT_TITLE && (a.constructor.title_color || this.render_title_colored)) {
          ...
          if (this.use_gradients) {
            var q = k.gradients[p];
            q || (q = k.gradients[p] = b.createLinearGradient(0, 0, 400, 0), q.addColorStop(0, p), q.addColorStop(1, "#000"));
            b.fillStyle = q;
          } else {
            b.fillStyle = p;
          }
      ...
      !l && (b.font = a.title_font && !a.flags.collapsed ? a.title_font : this.title_text_font, l = a.getTitle()) && (b.fillStyle = h ? "white" : a.constructor.title_text_color || this.node_title_color, a.flags.collapsed ? (b.textAlign = "center", g = b.measureText(l), b.fillText(l, e + 0.5 * g.width, f.NODE_TITLE_TEXT_Y - e), b.textAlign = "left") : (b.textAlign = "left", b.fillText(l, e, f.NODE_TITLE_TEXT_Y - e)));
      if (a.onDrawTitle) {
        a.onDrawTitle(b);
      }
    }
      ...
      if (h.inputs && h.inputs.length) {
        for (var g = 0; g < h.inputs.length; ++g) {
          ...
          if (l && null != l.link && (l = this.graph.links[l.link])) {
            var k = this.graph.getNodeById(l.origin_id);
            if (null != k) {
              var n = l.origin_slot;
              var p = -1 == n ? [k.pos[0] + 10, k.pos[1] + 10] : k.getConnectionPos(!1, n, H);
              var q = h.getConnectionPos(!0, g, I);
              x[0] = p[0];
              x[1] = p[1];
              x[2] = q[0] - p[0];
              x[3] = q[1] - p[1];
              ...
              if (D(x, E)) {
                var r = k.outputs[n];
                n = h.inputs[g];
                if (r && n && (k = r.dir || (k.horizontal ? f.DOWN : f.RIGHT), n = n.dir || (h.horizontal ? f.UP : f.LEFT), this.renderLink(a, p, q, l, !1, 0, null, k, n), l && l._last_time && 1000 > b - l._last_time)) {
                  r = 2.0 - 0.002 * (b - l._last_time);
                  var m = a.globalAlpha;
                  a.globalAlpha = m * r;
                  this.renderLink(a, p, q, l, !0, r, "white", k, n);
                  a.globalAlpha = m;
                }
              }
            }
  ...
  k.prototype.renderLink = function(a, b, c, d, e, h, g, l, r, n) {
    ...
    if (h) {
      for (a.fillStyle = g, q = 0; 5 > q; ++q) {
        h = (0.001 * f.getTime() + 0.2 * q) % 1, e = this.computeConnectionPoint(b, c, h, l, r), a.beginPath(), a.arc(e[0], e[1], 5, 0, 2 * Math.PI), a.fill();
      }
    }
  };
  k.prototype.computeConnectionPoint = function(a, b, c, d, e) {
    d = d || f.RIGHT;
    e = e || f.LEFT;
    var h = F(a, b), g = [a[0], a[1]], l = [b[0], b[1]];
    switch(d) {
      case f.LEFT:
        g[0] += -0.25 * h;
        break;
    ...
    h = 3 * (1 - c) * c * c;
    c *= c * c;
    return [d * a[0] + e * g[0] + h * l[0] + c * b[0], d * a[1] + e * g[1] + h * l[1] + c * b[1]];
  };
  ...
  k.prototype.drawNodeWidgets = function(a, b, c, d) {
    ...
    for (var k = f.WIDGET_OUTLINE_COLOR, n = f.WIDGET_BGCOLOR, p = f.WIDGET_TEXT_COLOR, q = f.WIDGET_SECONDARY_TEXT_COLOR, r = 0; r < h.length; ++r) {
      var m = h[r], t = b;
      m.y && (t = m.y);
      m.last_y = t;
      c.strokeStyle = k;
  ...
  k.prototype.processNodeWidgets = function(a, b, c, d) {
    ...
    for (var h = b[0] - a.pos[0], g = b[1] - a.pos[1], l = a.size[0], k = this, n = this.getCanvasWindow(), p = 0; p < a.widgets.length; ++p) {
      var q = a.widgets[p];
      if (q == d || 6 < h && h < l - 12 && g > q.last_y && g < q.last_y + f.NODE_WIDGET_HEIGHT) {
        switch(q.type) {
          case "button":
            if ("mousemove" === c.type) {
              break;
          ...
          case "number":
          case "combo":
            "mousemove" == c.type && "number" == q.type ? (q.value += 0.1 * c.deltaX * (q.options.step || 1), null != q.options.min && q.value < q.options.min && (q.value = q.options.min), null != q.options.max && q.value > q.options.max && (q.value = q.options.max)) : "mousedown" == c.type && ((d = q.options.values) && d.constructor === Function && (d = q.options.values(q, a)), h = 40 > h ? -1 : h > l - 40 ? 1 : 0, "number" == q.type ? (q.value += 0.1 * h * (q.options.step || 1), null != q.options.min && 
            q.value < q.options.min && (q.value = q.options.min), null != q.options.max && q.value > q.options.max && (q.value = q.options.max)) : h ? (n = d.indexOf(q.value) + h, n >= d.length && (n = 0), 0 > n && (n = d.length - 1), q.value = d[n]) : new f.ContextMenu(d, {scale:Math.max(1, this.ds.scale), event:c, className:"dark", callback:function(a, b, c) {
              this.value = a;
              e(this, a);
              k.dirty_canvas = !0;
              return !1;
  ...
  k.onMenuAdd = function(a, b, c, d) {
    ...
    var h = k.active_canvas, g = h.getCanvasWindow();
    a = f.getNodeTypesCategories(h.filter);
    b = [];
    for (var l in a) {
      a[l] && b.push({value:a[l], content:a[l], has_submenu:!0});
    }
    var m = new f.ContextMenu(b, {event:c, callback:function(a, b, c) {
      a = f.getNodeTypesInCategory(a.value, h.filter);
      b = [];
      for (var d in a) {
    ...
    if (e) {
      ...
      if (g.length) {
        return new f.ContextMenu(g, {event:c, callback:function(a, b, c) {
          e && (a.callback && a.callback.call(h, e, a, b, c), a.value && (e.addInput(a.value[0], a.value[1], a.value[2]), e.setDirtyCanvas(!0, !0)));
  ...
  k.showMenuNodeOptionalOutputs = function(a, b, c, d, e) {
    ...
    if (e) {
      ...
      if (l.length) {
        return new f.ContextMenu(l, {event:c, callback:h, parentMenu:d, node:e}, a), !1;
      }
    }
  };
  k.onShowMenuNodeProperties = function(a, b, c, d, e) {
    if (e && e.properties) {
      var h = k.active_canvas;
      b = h.getCanvasWindow();
      var g = [], l;
      for (l in e.properties) {
        a = void 0 !== e.properties[l] ? e.properties[l] : " ", a = k.decodeHTML(a), g.push({content:"<span class='property_name'>" + l + "</span><span class='property_value'>" + a + "</span>", value:l});
      }
      if (g.length) {
  ...
  k.prototype.prompt = function(a, b, c, d) {
    var e = this;
    a = a || "";
  ...
  k.prototype.showSearchBox = function(a) {
      ...
      if (c) {
        if (e.onSearchBox) {
          ...
          for (g in f.searchbox_extras) {
            var h = f.searchbox_extras[g];
            if (-1 !== h.desc.toLowerCase().indexOf(c) && (a(h.desc, "searchbox_extra"), -1 !== k.search_limit && d++ > k.search_limit)) {
              break;
            }
          }
          if (Array.prototype.filter) {
            for (h = Object.keys(f.registered_node_types).filter(function(a) {
              return -1 !== a.toLowerCase().indexOf(c);
            }), g = 0; g < h.length && !(a(h[g]), -1 !== k.search_limit && d++ > k.search_limit); g++) {
            }
          } else {
            for (g in f.registered_node_types) {
              if (-1 != g.indexOf(c) && (a(g), -1 !== k.search_limit && d++ > k.search_limit)) {
                break;
              }
            }
          }
    ...
    var e = this, h = document.createElement("div");
    ...
    e.search_box = h;
    var l = h.querySelector(".helper"), m = null, n = null, p = null, q = h.querySelector("input");
      ...
      if (38 == a.keyCode) {
        ...
        if (40 == a.keyCode) {
          ...
          if (27 == a.keyCode) {
            ...
            if (13 == a.keyCode) {
              setTimeout(function() {
                k.active_canvas.last_mouse_position[0] += 200;
              }, 30), p ? b(p.innerHTML) : m ? b(m) : h.close();
            } else {
              n && clearInterval(n);
              n = setTimeout(d, 10);
              return;
    ...
    var r = k.active_canvas, t = r.canvas, u = t.getBoundingClientRect(), v = -20, x = -20;
    u && (v -= u.left, x -= u.top);
    u = r.last_mouse_position;
    a ? (h.style.left = a.clientX + v + "px", h.style.top = a.clientY + x + "px") : u && u[0] && u[1] ? (h.style.left = u[0] + v + "px", h.style.top = u[1] + x + "px") : (h.style.left = 0.5 * t.width + v + "px", h.style.top = 0.5 * t.height + x + "px");
      ...
      if ("string" == f || "number" == f || "array" == f) {
        ...
        if ("enum" == f && g.values) {
          ...
          for (l in g.values) {
            ...
            k += "<option value='" + m + "' " + (m == a.properties[b] ? "selected" : "") + ">" + g.values[l] + "</option>";
          }
          k += "</select>";
        } else {
          if ("boolean" == f) {
  ...
  k.onMenuNodeColors = function(a, b, c, d, e) {
    ...
    for (var h in k.node_colors) {
      a = k.node_colors[h], a = {value:h, content:"<span style='display: block; color: #999; padding-left: 4px; border-left: 8px solid " + a.color + "; background-color:" + a.bgcolor + "'>" + h + "</span>"}, b.push(a);
    }
  ...
  k.prototype.processContextMenu = function(a, b) {
    ...
    g ? (e = [], g && g.output && g.output.links && g.output.links.length && e.push({content:"Disconnect Links", slot:g}), b = g.input || g.output, e.push(b.locked ? "Cannot remove" : {content:"Remove Slot", slot:g}), e.push(b.nameLocked ? "Cannot rename" : {content:"Rename Slot", slot:g}), h.title = (g.input ? g.input.type : g.output.type) || "*", g.input && g.input.type == f.ACTION && (h.title = "Action"), g.output && g.output.type == f.EVENT && (h.title = "Event")) : a ? e = this.getNodeMenuOptions(a) : 
