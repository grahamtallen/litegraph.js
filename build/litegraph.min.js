...
(function(t) {
  ...
  function C(a, b) {
    ...
    g = b.left || 0;
    a = b.top || 0;
    b.event && (g = b.event.clientX - 10, a = b.event.clientY - 10, b.title && (a -= 20), b.parentMenu && (g = b.parentMenu.root.getBoundingClientRect(), g = g.left + g.width), f = document.body.getBoundingClientRect(), k = e.getBoundingClientRect(), g > f.width - k.width - 10 && (g = f.width - k.width - 10), a > f.height - k.height - 10 && (a = f.height - k.height - 10));
    e.style.left = g + "px";
    e.style.top = a + "px";
  ...
  STRAIGHT_LINK:0, LINEAR_LINK:1, SPLINE_LINK:2, NORMAL_TITLE:0, NO_TITLE:1, TRANSPARENT_TITLE:2, AUTOHIDE_TITLE:3, proxy:null, node_images_path:"", debug:!0, catch_exceptions:!0, throw_errors:!0, allow_scripts:!1, registered_node_types:{}, node_types_by_file_extension:{}, Nodes:{}, searchbox_extras:{}, registerNodeType:function(a, b) {
    ...
    for (var h = Array(b.length), g = "", k = f.getParameterNames(b), v = 0; v < k.length; ++v) {
      g += "this.addInput('" + k[v] + "'," + (c && c[v] ? "'" + c[v] + "'" : "0") + ");\n";
    }
    ...
    if (e) {
      ...
      if (b) {
        ...
        try {
          for (h = 0; h < a; h++) {
            for (g = 0; g < c; ++g) {
              if (k = e[g], k.mode == f.ALWAYS && k.onExecute) {
                k.onExecute();
              }
            }
            this.fixedtime += this.fixedtime_lapse;
  ...
  m.prototype.computeExecutionOrder = function(a, b) {
    for (var c = [], d = [], e = {}, h = {}, g = {}, k = 0, v = this._nodes.length; k < v; ++k) {
      var n = this._nodes[k];
      if (!a || n.onExecute) {
        e[n.id] = n;
        var p = 0;
        if (n.inputs) {
          for (var q = 0, l = n.inputs.length; q < l; q++) {
        ...
        for (k = 0; k < n.outputs.length; k++) {
          if (a = n.outputs[k], null != a && null != a.links && 0 != a.links.length) {
            for (q = 0; q < a.links.length; q++) {
              (v = this.links[a.links[q]]) && !h[v.id] && (p = this.getNodeById(v.target_id), null == p ? h[v.id] = !0 : (b && (!p._level || p._level <= n._level) && (p._level = n._level + 1), h[v.id] = !0, --g[p.id], 0 == g[p.id] && d.push(p)));
            }
          }
        }
      }
  ...
  m.prototype.arrange = function(a) {
    ...
    for (d = 0; d < c.length; ++d) {
      if (f = c[d]) {
        for (var g = 100, k = a, l = 0; l < f.length; ++l) {
          e = f[l], e.pos[0] = b, e.pos[1] = k, e.size[0] > g && (g = e.size[0]), k += e.size[1] + a;
        }
        b += g + a;
      }
    }
  ...
  r.prototype.computeSize = function(a, b) {
    ...
    if (this.outputs) {
      for (g = 0, k = this.outputs.length; g < k; ++g) {
        l = this.outputs[g], l = l.label || l.name || "", l = c(l), h < l && (h = l);
      }
    }
  ...
  r.prototype.connect = function(a, b, c) {
    ...
    if (f.isValidConnection(d.type, e.type)) {
      h = new w(++this.graph.last_link_id, e.type, this.id, a, b.id, c);
  ...
  t.LGraphCanvas = f.LGraphCanvas = l;
  l.link_type_colors = {"-1":f.EVENT_LINK_COLOR, number:"#AAA", node:"#DCA"};
  l.gradients = {};
          ...
          if (c && this.allow_interaction && !d && !this.read_only) {
            ...
            if (!this.connecting_node && !c.flags.collapsed && !this.live_mode) {
              if (!d && !1 !== c.resizable && A(a.canvasX, a.canvasY, c.pos[0] + c.size[0] - 5, c.pos[1] + c.size[1] - 5, 10, 10)) {
                ...
                if (c.outputs) {
                  for (var g = 0, k = c.outputs.length; g < k; ++g) {
                    var v = c.outputs[g], n = c.getConnectionPos(!1, g);
                    if (A(a.canvasX, a.canvasY, n[0] - 15, n[1] - 10, 30, 20)) {
                      this.connecting_node = c;
                      this.connecting_output = v;
                ...
                if (c.inputs) {
                  for (g = 0, k = c.inputs.length; g < k; ++g) {
                    if (v = c.inputs[g], n = c.getConnectionPos(!0, g), A(a.canvasX, a.canvasY, n[0] - 15, n[1] - 10, 30, 20)) {
                      if (e) {
            ...
            if (!d) {
              g = !1;
              if (k = this.processNodeWidgets(c, this.canvas_mouse, a)) {
                g = !0, this.node_widget = [c, k];
              }
  ...
  l.prototype.isOverNodeInput = function(a, b, c, d) {
    if (a.inputs) {
  ...
  l.prototype.processKey = function(a) {
    if (this.graph) {
      ...
      if ("input" != a.target.localName) {
        if ("keydown" == a.type) {
          if ("Escape" == a.key && this.closeSubgraph(), 32 == a.keyCode && (this.showSearchBox(), b = !0), 65 == a.keyCode && (a.metaKey || a.ctrlKey) && (this.selectNodes(), b = !0), "KeyC" == a.code && (a.metaKey || a.ctrlKey) && !a.shiftKey && this.selected_nodes && (this.copyToClipboard(), b = !0), "KeyV" != a.code || !a.metaKey && !a.ctrlKey || a.shiftKey || this.pasteFromClipboard(), 46 != a.keyCode && 8 != a.keyCode || "input" == a.target.localName || "textarea" == a.target.localName || (this.deleteSelectedNodes(), 
          b = !0), this.selected_nodes) {
        ...
        for (b = 0; b < e.inputs.length; b++) {
          ...
          if (f && null != f.link) {
            ...
            if (g) {
              ...
              k && this.selected_nodes[k.id] && (console.log("PUSH", b, f, k, e), a.links.push([k._relative_id, g.origin_slot, e._relative_id, g.target_slot]));
            }
          }
        }
      }
      ...
      if ((c.onDropFile || c.onDropData) && (b = a.dataTransfer.files) && b.length) {
        for (var d = 0; d < b.length; d++) {
          ...
          if (c.onDropData) {
            ...
            "text" == k || "" == k ? g.readAsText(e) : "image" == k ? g.readAsDataURL(e) : g.readAsArrayBuffer(e);
          }
        }
      }
  ...
  l.prototype.processNodeDeselected = function(a) {
    this.deselectNode(a);
  ...
  l.prototype.convertEventToCanvasOffset = function(a) {
    var b = l.active_canvas, c = b.canvas, d = c.width / 2;
    c = c.height / 2;
    ...
    if (this.live_mode) {
      ...
      if (!a.flags.collapsed || !a.onDrawCollapsed || 1 != a.onDrawCollapsed(b, this)) {
        ...
        if (a.flags.collapsed) {
          ...
          null != k && (a._collapsed_width = Math.min(a.size[0], b.measureText(k).width + 2 * f.NODE_TITLE_HEIGHT), B[0] = a._collapsed_width, B[1] = 0);
        }
        ...
        if (!a.flags.collapsed) {
          if (a.inputs) {
            for (c = 0; c < a.inputs.length; c++) {
              ...
              var p = a.getConnectionPos(!0, c, l);
              p[0] -= a.pos[0];
              p[1] -= a.pos[1];
              k < p[1] + 0.5 * f.NODE_SLOT_HEIGHT && (k = p[1] + 0.5 * f.NODE_SLOT_HEIGHT);
              b.beginPath();
          ...
          if (a.outputs) {
            for (c = 0; c < a.outputs.length; c++) {
              if (n = a.outputs[c], p = a.getConnectionPos(!1, c, l), p[0] -= a.pos[0], p[1] -= a.pos[1], k < p[1] + 0.5 * f.NODE_SLOT_HEIGHT && (k = p[1] + 0.5 * f.NODE_SLOT_HEIGHT), b.fillStyle = n.links && n.links.length ? n.color_on || this.default_connection_color.output_on : n.color_off || this.default_connection_color.output_off, b.beginPath(), n.type === f.EVENT || n.shape === f.BOX_SHAPE ? g ? b.rect(p[0] - 5 + 0.5, p[1] - 8 + 0.5, 10, 14) : b.rect(p[0] - 6 + 0.5, p[1] - 5 + 0.5, 14, 10) : 
  ...
  l.prototype.drawNodeShape = function(a, b, c, d, e, h, g) {
    b.strokeStyle = d;
    b.fillStyle = e;
    e = f.NODE_TITLE_HEIGHT;
    var k = 0.5 > this.ds.scale, v = a._shape || a.constructor.shape || f.ROUND_SHAPE, n = a.constructor.title_mode, p = !0;
    ...
    g = b.globalAlpha;
    b.beginPath();
    v == f.BOX_SHAPE || k ? b.fillRect(u[0], u[1], u[2], u[3]) : v == f.ROUND_SHAPE || v == f.CARD_SHAPE ? b.roundRect(u[0], u[1], u[2], u[3], this.round_radius, v == f.CARD_SHAPE ? 0 : this.round_radius) : v == f.CIRCLE_SHAPE && b.arc(0.5 * c[0], 0.5 * c[1], 0.5 * c[0], 0, 2 * Math.PI);
    b.fill();
    ...
    if (p || n == f.TRANSPARENT_TITLE) {
      if (a.onDrawTitleBar) {
        ...
        if (n != f.TRANSPARENT_TITLE && (a.constructor.title_color || this.render_title_colored)) {
          ...
          if (this.use_gradients) {
            var q = l.gradients[p];
            q || (q = l.gradients[p] = b.createLinearGradient(0, 0, 400, 0), q.addColorStop(0, p), q.addColorStop(1, "#000"));
            b.fillStyle = q;
          } else {
            b.fillStyle = p;
          }
          b.beginPath();
          v == f.BOX_SHAPE || k ? b.rect(0, -e, c[0] + 1, e) : (v == f.ROUND_SHAPE || v == f.CARD_SHAPE) && b.roundRect(0, -e, c[0] + 1, e, this.round_radius, a.flags.collapsed ? this.round_radius : 0);
          b.fill();
          b.shadowColor = "transparent";
        }
      }
      if (a.onDrawTitleBox) {
        ...
        v == f.ROUND_SHAPE || v == f.CIRCLE_SHAPE || v == f.CARD_SHAPE ? (k && (b.fillStyle = "black", b.beginPath(), b.arc(0.5 * e, -0.5 * e, 6, 0, 2 * Math.PI), b.fill()), b.fillStyle = a.boxcolor || f.NODE_DEFAULT_BOXCOLOR, b.beginPath(), b.arc(0.5 * e, -0.5 * e, 5, 0, 2 * Math.PI), b.fill()) : (k && (b.fillStyle = "black", b.fillRect(0.5 * (e - 10) - 1, -0.5 * (e + 10) - 1, 12, 12)), b.fillStyle = a.boxcolor || f.NODE_DEFAULT_BOXCOLOR, b.fillRect(0.5 * (e - 10), -0.5 * (e + 10), 10, 10));
      }
      b.globalAlpha = g;
      if (a.onDrawTitleText) {
        a.onDrawTitleText(b, e, c, this.ds.scale, this.title_text_font, h);
      }
      !k && (b.font = a.title_font && !a.flags.collapsed ? a.title_font : this.title_text_font, k = a.getTitle()) && (b.fillStyle = h ? "white" : a.constructor.title_text_color || this.node_title_color, a.flags.collapsed ? (b.textAlign = "center", g = b.measureText(k), b.fillText(k, e + 0.5 * g.width, f.NODE_TITLE_TEXT_Y - e), b.textAlign = "left") : (b.textAlign = "left", b.fillText(k, e, f.NODE_TITLE_TEXT_Y - e)));
      if (a.onDrawTitle) {
        a.onDrawTitle(b);
      }
    }
    if (h) {
      ...
      b.globalAlpha = 0.8;
      b.beginPath();
      v == f.BOX_SHAPE ? b.rect(-6 + u[0], -6 + u[1], 12 + u[2], 12 + u[3]) : v == f.ROUND_SHAPE || v == f.CARD_SHAPE && a.flags.collapsed ? b.roundRect(-6 + u[0], -6 + u[1], 12 + u[2], 12 + u[3], 2 * this.round_radius) : v == f.CARD_SHAPE ? b.roundRect(-6 + u[0], -6 + u[1], 12 + u[2], 12 + u[3], 2 * this.round_radius, 2) : v == f.CIRCLE_SHAPE && b.arc(0.5 * c[0], 0.5 * c[1], 0.5 * c[0] + 6, 0, 2 * Math.PI);
      b.strokeStyle = "#FFF";
      b.stroke();
      b.strokeStyle = d;
      b.globalAlpha = 1;
      ...
      if (h.inputs && h.inputs.length) {
        for (var g = 0; g < h.inputs.length; ++g) {
          ...
          if (k && null != k.link && (k = this.graph.links[k.link])) {
            ...
            if (null != l) {
              var n = k.origin_slot;
              var p = -1 == n ? [l.pos[0] + 10, l.pos[1] + 10] : l.getConnectionPos(!1, n, H);
              ...
              if (D(x, E)) {
                var r = l.outputs[n];
                n = h.inputs[g];
                if (r && n && (l = r.dir || (l.horizontal ? f.DOWN : f.RIGHT), n = n.dir || (h.horizontal ? f.UP : f.LEFT), this.renderLink(a, p, q, k, !1, 0, null, l, n), k && k._last_time && 1000 > b - k._last_time)) {
                  r = 2.0 - 0.002 * (b - k._last_time);
                  var m = a.globalAlpha;
                  a.globalAlpha = m * r;
                  this.renderLink(a, p, q, k, !0, r, "white", l, n);
                  a.globalAlpha = m;
                }
              }
            }
  ...
  l.prototype.renderLink = function(a, b, c, d, e, h, g, k, v, n) {
    d && this.visible_links.push(d);
    !g && d && (g = d.color || l.link_type_colors[d.type]);
    ...
    for (var q = 0; q < n; q += 1) {
      ...
      if (this.links_render_mode == f.SPLINE_LINK) {
        ...
        a.bezierCurveTo(b[0] + m, b[1] + t + r, c[0] + u, c[1] + w + r, c[0], c[1] + r);
      } else {
        if (this.links_render_mode == f.LINEAR_LINK) {
          ...
          a.lineTo(b[0] + 15 * m, b[1] + 15 * t + r);
          a.lineTo(c[0] + 15 * u, c[1] + 15 * w + r);
          a.lineTo(c[0], c[1] + r);
        } else {
          if (this.links_render_mode == f.STRAIGHT_LINK) {
            a.moveTo(b[0], b[1]), r = b[0], m = b[1], t = c[0], u = c[1], k == f.RIGHT ? r += 10 : m += 10, v == f.LEFT ? t -= 10 : u -= 10, a.lineTo(r, m), a.lineTo(0.5 * (r + t), m), a.lineTo(0.5 * (r + t), u), a.lineTo(t, u), a.lineTo(c[0], c[1]);
          } else {
            return;
          }
        }
    ...
    a.stroke();
    e = this.computeConnectionPoint(b, c, 0.5, k, v);
    d && d._pos && (d._pos[0] = e[0], d._pos[1] = e[1]);
    0.6 <= this.ds.scale && this.highquality_render && v != f.CENTER && (this.render_connection_arrows && (q = this.computeConnectionPoint(b, c, 0.25, k, v), p = this.computeConnectionPoint(b, c, 0.26, k, v), d = this.computeConnectionPoint(b, c, 0.75, k, v), n = this.computeConnectionPoint(b, c, 0.76, k, v), this.render_curved_connections ? (p = -Math.atan2(p[0] - q[0], p[1] - q[1]), n = -Math.atan2(n[0] - d[0], n[1] - d[1])) : n = p = c[1] > b[1] ? 0 : Math.PI, a.save(), a.translate(q[0], q[1]), 
    ...
    if (h) {
      for (a.fillStyle = g, q = 0; 5 > q; ++q) {
        h = (0.001 * f.getTime() + 0.2 * q) % 1, e = this.computeConnectionPoint(b, c, h, k, v), a.beginPath(), a.arc(e[0], e[1], 5, 0, 2 * Math.PI), a.fill();
      }
    }
  };
  l.prototype.computeConnectionPoint = function(a, b, c, d, e) {
    d = d || f.RIGHT;
    e = e || f.LEFT;
    var h = F(a, b), g = [a[0], a[1]], k = [b[0], b[1]];
    switch(d) {
      case f.LEFT:
        g[0] += -0.25 * h;
        break;
  ...
  l.prototype.drawNodeWidgets = function(a, b, c, d) {
    ...
    for (var l = f.WIDGET_OUTLINE_COLOR, n = f.WIDGET_BGCOLOR, p = f.WIDGET_TEXT_COLOR, q = f.WIDGET_SECONDARY_TEXT_COLOR, r = 0; r < h.length; ++r) {
      var m = h[r], t = b;
      m.y && (t = m.y);
      m.last_y = t;
      c.strokeStyle = l;
      ...
      switch(m.type) {
        case "button":
          ...
          k && (c.textAlign = "center", c.fillStyle = p, c.fillText(m.name, 0.5 * e, t + 0.7 * g));
          break;
        case "toggle":
          c.textAlign = "left";
          c.strokeStyle = l;
          ...
          c.fill();
          k && (c.fillStyle = q, null != m.name && c.fillText(m.name, 30, t + 0.7 * g), c.fillStyle = m.value ? p : q, c.textAlign = "right", c.fillText(m.value ? m.options.on || "true" : m.options.off || "false", e - 40, t + 0.7 * g));
          break;
        case "slider":
          c.fillStyle = n;
          c.fillRect(15, t, e - 30, g);
          var u = m.options.max - m.options.min, w = (m.value - m.options.min) / u;
          c.fillStyle = d == m ? "#89A" : "#678";
          c.fillRect(15, t, w * (e - 30), g);
          c.strokeRect(15, t, e - 30, g);
          m.marker && (u = (m.marker - m.options.min) / u, c.fillStyle = "#AA9", c.fillRect(15 + u * (e - 30), t, 2, g));
          k && (c.textAlign = "center", c.fillStyle = p, c.fillText(m.name + "  " + Number(m.value).toFixed(3), 0.5 * e, t + 0.7 * g));
          break;
        case "number":
        case "combo":
          c.textAlign = "left";
          ...
          c.fill();
          c.stroke();
          k && (c.fillStyle = p, c.beginPath(), c.moveTo(31, b + 5), c.lineTo(21, b + 0.5 * g), c.lineTo(31, b + g - 5), c.moveTo(e - 15 - 16, b + 5), c.lineTo(e - 15 - 6, b + 0.5 * g), c.lineTo(e - 15 - 16, b + g - 5), c.fill(), c.fillStyle = q, c.fillText(m.name, 35, t + 0.7 * g), c.fillStyle = p, c.textAlign = "right", "number" == m.type ? c.fillText(Number(m.value).toFixed(void 0 !== m.options.precision ? m.options.precision : 3), e - 30 - 20, t + 0.7 * g) : c.fillText(m.value, e - 30 - 20, t + 
          0.7 * g));
          break;
        case "string":
        case "text":
          ...
          c.fill();
          c.stroke();
          k && (c.fillStyle = q, null != m.name && c.fillText(m.name, 30, t + 0.7 * g), c.fillStyle = p, c.textAlign = "right", c.fillText(m.value, e - 30, t + 0.7 * g));
          break;
        default:
  ...
  l.prototype.processNodeWidgets = function(a, b, c, d) {
    function e(d, e) {
      d.value = e;
    ...
    for (var h = b[0] - a.pos[0], g = b[1] - a.pos[1], k = a.size[0], l = this, n = this.getCanvasWindow(), p = 0; p < a.widgets.length; ++p) {
      var q = a.widgets[p];
      if (q == d || 6 < h && h < k - 12 && g > q.last_y && g < q.last_y + f.NODE_WIDGET_HEIGHT) {
        switch(q.type) {
          case "button":
            if ("mousemove" === c.type) {
              break;
          ...
          case "number":
          case "combo":
            "mousemove" == c.type && "number" == q.type ? (q.value += 0.1 * c.deltaX * (q.options.step || 1), null != q.options.min && q.value < q.options.min && (q.value = q.options.min), null != q.options.max && q.value > q.options.max && (q.value = q.options.max)) : "mousedown" == c.type && ((d = q.options.values) && d.constructor === Function && (d = q.options.values(q, a)), h = 40 > h ? -1 : h > k - 40 ? 1 : 0, "number" == q.type ? (q.value += 0.1 * h * (q.options.step || 1), null != q.options.min && 
  ...
  l.onMenuAdd = function(a, b, c, d) {
    ...
    var h = l.active_canvas, g = h.getCanvasWindow();
  ...
  l.showMenuNodeOptionalInputs = function(a, b, c, d, e) {
    if (e) {
      var h = this;
  ...
  l.showMenuNodeOptionalOutputs = function(a, b, c, d, e) {
    function h(a, b, c) {
  ...
  l.onShowMenuNodeProperties = function(a, b, c, d, e) {
    if (e && e.properties) {
      var h = l.active_canvas;
      b = h.getCanvasWindow();
      var g = [], k;
      for (k in e.properties) {
        a = void 0 !== e.properties[k] ? e.properties[k] : " ", a = l.decodeHTML(a), g.push({content:"<span class='property_name'>" + k + "</span><span class='property_value'>" + a + "</span>", value:k});
      }
      if (g.length) {
  ...
  l.onResizeNode = function(a, b, c, d, e) {
  ...
  l.onShowPropertyEditor = function(a, b, c, d, e) {
    function f() {
      var b = m.value;
    ...
    var n = d = -20;
    c && (d -= c.left, n -= c.top);
    event ? (k.style.left = event.clientX + d + "px", k.style.top = event.clientY + n + "px") : (k.style.left = 0.5 * b.width + d + "px", k.style.top = 0.5 * b.height + n + "px");
    k.querySelector("button").addEventListener("click", f);
    b.parentNode.appendChild(k);
  };
  l.prototype.prompt = function(a, b, c, d) {
    var e = this;
    a = a || "";
  ...
  l.prototype.showSearchBox = function(a) {
      ...
      if (c) {
        if (e.onSearchBox) {
          ...
          for (g in f.searchbox_extras) {
            ...
            if (-1 !== h.desc.toLowerCase().indexOf(c) && (a(h.desc, "searchbox_extra"), -1 !== l.search_limit && d++ > l.search_limit)) {
              break;
            }
          }
          if (Array.prototype.filter) {
            ...
            }), g = 0; g < h.length && !(a(h[g]), -1 !== l.search_limit && d++ > l.search_limit); g++) {
            }
          } else {
            for (g in f.registered_node_types) {
              if (-1 != g.indexOf(c) && (a(g), -1 !== l.search_limit && d++ > l.search_limit)) {
                break;
              }
            }
          }
    ...
    e.search_box = h;
    var k = h.querySelector(".helper"), m = null, n = null, p = null, q = h.querySelector("input");
    ...
    var r = l.active_canvas, t = r.canvas, u = t.getBoundingClientRect(), w = -20, x = -20;
    u && (w -= u.left, x -= u.top);
    u = r.last_mouse_position;
    a ? (h.style.left = a.clientX + w + "px", h.style.top = a.clientY + x + "px") : u && u[0] && u[1] ? (h.style.left = u[0] + w + "px", h.style.top = u[1] + x + "px") : (h.style.left = 0.5 * t.width + w + "px", h.style.top = 0.5 * t.height + x + "px");
    ...
    if (a && void 0 !== a.properties[b]) {
      ...
      if ("string" == f || "number" == f || "array" == f) {
        ...
        if ("enum" == f && g.values) {
          ...
          for (k in g.values) {
            var m = g.values.constructor === Array ? g.values[k] : k;
            l += "<option value='" + m + "' " + (m == a.properties[b] ? "selected" : "") + ">" + g.values[k] + "</option>";
          }
          l += "</select>";
        } else {
          if ("boolean" == f) {
      ...
      var p = this.createDialog("<span class='name'>" + b + "</span>" + l + "<button>OK</button>", c);
      if ("enum" == f && g.values) {
  ...
  l.onMenuNodeCollapse = function(a, b, c, d, e) {
    e.collapse();
  };
  l.onMenuNodePin = function(a, b, c, d, e) {
    e.pin();
  };
  l.onMenuNodeMode = function(a, b, c, d, e) {
  ...
  l.onMenuNodeColors = function(a, b, c, d, e) {
    if (!e) {
    ...
    new f.ContextMenu(b, {event:c, callback:function(a) {
      e && ((a = a.value ? l.node_colors[a.value] : null) ? e.constructor === f.LGraphGroup ? e.color = a.groupcolor : (e.color = a.color, e.bgcolor = a.bgcolor) : (delete e.color, delete e.bgcolor), e.setDirtyCanvas(!0, !0));
    }, parentMenu:d, node:e});
    return !1;
  };
  l.onMenuNodeShapes = function(a, b, c, d, e) {
    if (!e) {
  ...
  l.onMenuNodeRemove = function(a, b, c, d, e) {
    if (!e) {
      throw "no node passed";
    }
    !1 !== e.removable && (e.graph.remove(e), e.setDirtyCanvas(!0, !0));
  };
  l.onMenuNodeClone = function(a, b, c, d, e) {
  ...
  l.prototype.processContextMenu = function(a, b) {
    var c = this, d = l.active_canvas.getCanvasWindow(), e = null, h = {event:b, callback:function(b, d, e) {
      if (b) {
    ...
    a && (h.title = a.type);
    var g = null;
    a && (g = a.getSlotInPosition(b.canvasX, b.canvasY), l.active_node = a);
