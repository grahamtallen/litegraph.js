...
(function(t) {
  ...
  LINEAR_LINK:1, SPLINE_LINK:2, NORMAL_TITLE:0, NO_TITLE:1, TRANSPARENT_TITLE:2, AUTOHIDE_TITLE:3, proxy:null, node_images_path:"", debug:!1, catch_exceptions:!0, throw_errors:!0, allow_scripts:!1, registered_node_types:{}, node_types_by_file_extension:{}, Nodes:{}, searchbox_extras:{}, registerNodeType:function(a, b) {
    ...
    for (var h = Array(b.length), g = "", l = f.getParameterNames(b), u = 0; u < l.length; ++u) {
      g += "this.addInput('" + l[u] + "'," + (c && c[u] ? "'" + c[u] + "'" : "0") + ");\n";
    }
  ...
  m.prototype.computeExecutionOrder = function(a, b) {
    for (var c = [], d = [], e = {}, h = {}, g = {}, l = 0, u = this._nodes.length; l < u; ++l) {
      var n = this._nodes[l];
      if (!a || n.onExecute) {
        e[n.id] = n;
        var p = 0;
        if (n.inputs) {
          for (var q = 0, k = n.inputs.length; q < k; q++) {
        ...
        for (l = 0; l < n.outputs.length; l++) {
          if (a = n.outputs[l], null != a && null != a.links && 0 != a.links.length) {
            for (q = 0; q < a.links.length; q++) {
              (u = this.links[a.links[q]]) && !h[u.id] && (p = this.getNodeById(u.target_id), null == p ? h[u.id] = !0 : (b && (!p._level || p._level <= n._level) && (p._level = n._level + 1), h[u.id] = !0, --g[p.id], 0 == g[p.id] && d.push(p)));
            }
          }
        }
      }
              ...
              if (!d && !1 !== c.resizable && A(a.canvasX, a.canvasY, c.pos[0] + c.size[0] - 5, c.pos[1] + c.size[1] - 5, 10, 10)) {
                ...
                if (c.inputs) {
                  for (g = 0, l = c.inputs.length; g < l; ++g) {
                    if (u = c.inputs[g], n = c.getConnectionPos(!0, g), A(a.canvasX, a.canvasY, n[0] - 15, n[1] - 10, 30, 20)) {
                      if (e) {
      ...
      if (e = c[d], a.nodes.push(e.clone().serialize()), e.inputs && e.inputs.length) {
        for (b = 0; b < e.inputs.length; ++b) {
          ...
          if (f && null != f.link && (f = this.graph.links[f.link])) {
            ...
            g && this.selected_nodes[g.id] && a.links.push([g._relative_id, b, e._relative_id, f.target_slot]);
          }
        }
      }
    }
  ...
  k.prototype.drawNodeShape = function(a, b, c, d, e, h, g) {
    ...
    if (p || n == f.TRANSPARENT_TITLE) {
      ...
      !l && (b.font = this.title_text_font, l = a.getTitle()) && (b.fillStyle = h ? "white" : a.constructor.title_text_color || this.node_title_color, a.flags.collapsed ? (b.textAlign = "center", g = b.measureText(l), b.fillText(l, e + 0.5 * g.width, f.NODE_TITLE_TEXT_Y - e), b.textAlign = "left") : (b.textAlign = "left", b.fillText(l, e, f.NODE_TITLE_TEXT_Y - e)));
      if (a.onDrawTitle) {
        a.onDrawTitle(b);
      }
    }
  ...
  k.prototype.renderLink = function(a, b, c, d, e, h, g, l, u, n) {
    ...
    for (var q = 0; q < n; q += 1) {
      ...
      if (this.links_render_mode == f.SPLINE_LINK) {
        ...
        a.bezierCurveTo(b[0] + m, b[1] + t + r, c[0] + v, c[1] + w + r, c[0], c[1] + r);
      } else {
        if (this.links_render_mode == f.LINEAR_LINK) {
          ...
          a.lineTo(c[0] + 15 * v, c[1] + 15 * w + r);
          a.lineTo(c[0], c[1] + r);
        } else {
          if (this.links_render_mode == f.STRAIGHT_LINK) {
            a.moveTo(b[0], b[1]), r = b[0], m = b[1], t = c[0], v = c[1], l == f.RIGHT ? r += 10 : m += 10, u == f.LEFT ? t -= 10 : v -= 10, a.lineTo(r, m), a.lineTo(0.5 * (r + t), m), a.lineTo(0.5 * (r + t), v), a.lineTo(t, v), a.lineTo(c[0], c[1]);
          } else {
            return;
          }
        }
    ...
    a.stroke();
    e = this.computeConnectionPoint(b, c, 0.5, l, u);
    d && d._pos && (d._pos[0] = e[0], d._pos[1] = e[1]);
    0.6 <= this.ds.scale && this.highquality_render && u != f.CENTER && (this.render_connection_arrows && (q = this.computeConnectionPoint(b, c, 0.25, l, u), p = this.computeConnectionPoint(b, c, 0.26, l, u), d = this.computeConnectionPoint(b, c, 0.75, l, u), n = this.computeConnectionPoint(b, c, 0.76, l, u), this.render_curved_connections ? (p = -Math.atan2(p[0] - q[0], p[1] - q[1]), n = -Math.atan2(n[0] - d[0], n[1] - d[1])) : n = p = c[1] > b[1] ? 0 : Math.PI, a.save(), a.translate(q[0], q[1]), 
    ...
    if (h) {
      for (a.fillStyle = g, q = 0; 5 > q; ++q) {
        h = (0.001 * f.getTime() + 0.2 * q) % 1, e = this.computeConnectionPoint(b, c, h, l, u), a.beginPath(), a.arc(e[0], e[1], 5, 0, 2 * Math.PI), a.fill();
      }
    }
  };
    ...
    for (var k = f.WIDGET_OUTLINE_COLOR, n = f.WIDGET_BGCOLOR, p = f.WIDGET_TEXT_COLOR, q = f.WIDGET_SECONDARY_TEXT_COLOR, r = 0; r < h.length; ++r) {
      ...
      switch(m.type) {
        ...
        case "slider":
          c.fillStyle = n;
          c.fillRect(15, t, e - 30, g);
          var v = m.options.max - m.options.min, w = (m.value - m.options.min) / v;
          c.fillStyle = d == m ? "#89A" : "#678";
          c.fillRect(15, t, w * (e - 30), g);
          c.strokeRect(15, t, e - 30, g);
          m.marker && (v = (m.marker - m.options.min) / v, c.fillStyle = "#AA9", c.fillRect(15 + v * (e - 30), t, 2, g));
  ...
  k.prototype.showSearchBox = function(a) {
    ...
    var r = k.active_canvas, t = r.canvas, v = t.getBoundingClientRect(), w = -20, x = -20;
    v && (w -= v.left, x -= v.top);
    a ? (h.style.left = a.clientX + w + "px", h.style.top = a.clientY + x + "px") : (h.style.left = 0.5 * t.width + w + "px", h.style.top = 0.5 * t.height + x + "px");
